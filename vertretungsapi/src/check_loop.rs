...
pub fn init_vday_cache() -> (Arc<VdayCache>, Arc<UpdatedList>, JoinHandle<()>, CancellationToken){
...
async fn spawn_check_loop(cache: Arc<VdayCache>,updated_list:
     Arc<UpdatedList>, stop_signal: CancellationToken) {
